...
void screen(String mode) {
  ...
  if (mode == "COUNT_START") {
    /*=== COUNT_START Screen ===*/
    print_tiny_char( 7, 1, 'S');
    print_tiny_char( 11, 1, 'T');
    print_tiny_char( 15, 1, 'A');
    print_tiny_char( 19, 1, 'R');
    print_tiny_char( 23, 1, 'T');
  }
  ...
  if (mode == "ALARM_SET_ON") {
    /*=== ALARM_SET_ON Screen ===*/
    print_tiny_char( 5, 1, 'S');
    print_tiny_char( 9, 1, 'E');
    print_tiny_char( 13, 1, 'T');
    print_tiny_char( 17, 1, ':');
    print_tiny_char( 21, 1, 'O');
    print_tiny_char( 25, 1, 'N');
  }

  if (mode == "ALARM_SET_OFF") {
    /*=== ALARM_SET_OFF Screen ===*/
    print_tiny_char( 5, 1, 'S');
    print_tiny_char( 9, 1, 'E');
    print_tiny_char( 13, 1, 'T');
    print_tiny_char( 17, 1, ':');
    print_tiny_char( 21, 1, 'O');
    print_tiny_char( 25, 1, 'F');
    print_tiny_char( 29, 1, 'F');
  }
}
