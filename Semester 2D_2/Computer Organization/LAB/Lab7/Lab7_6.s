	.data
	.balign 4
@ Define all the string and variable
get_num_1:	.asciz "Number 1 :\n"

	.balign 4
get_num_2:	.asciz "Number 2 :\n"

@ printf and scanf use %d in decimal number
	.balign 4
pattern:	.asciz "%d"
...
sum_func:
    LDR R2, addr_lr_bu_2
    STR lr, [R2]
    ADD R0, R0, R1          @ Sum value in R0 and R1 then return in R0
	LDR lr, addr_lr_bu_2
	LDR lr, [lr]
	BX lr
